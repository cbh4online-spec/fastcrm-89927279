  ...
  try {
    ...
    if (!aiResponse.ok) {
      ...
      if (aiResponse.status === 429) {
        return new Response(
          JSON.stringify({ error: "Limite de pedidos atingido. Por favor, tente novamente mais tarde." }),
      ...
      return new Response(
        JSON.stringify({ error: "Falha ao gerar conteúdo. Tente novamente." }),
