...
BEGIN
  ...
  SELECT
    ...
    -- Sugestão respeita o modo: 'percent' = margem s/PVP; 'markup' = markup s/custo
    CASE
    ...
    -- Margem sobre PVP (gross margin) — padrão contabilístico PT
    ...
    -- Markup sobre custo (anglo-saxónico)
