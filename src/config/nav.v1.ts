...
export const NAV_V1_ITEMS: NavV1Item[] = [
  ...
  { name: "Clientes", href: "/dashboard/c2c/clients", icon: Users, group: "Marketplace C2C", moduleSlug: "marketplace-c2c" },
  { name: "Links Públicos", href: "/dashboard/c2c/public-links", icon: Globe, group: "Marketplace C2C", moduleSlug: "marketplace-c2c" },
  ...
  { name: "Notificações", href: "/dashboard/account-brief/notifications", icon: Bell, group: "Account Brief", moduleSlug: "account-brief" },
  ...
  { name: "Saúde", href: "/dashboard/account-brief/health", icon: Gauge, group: "Account Brief", moduleSlug: "account-brief" },
