        ...
        {!isLoading && currentWorkspace && (
          <div className="mb-6">
            <MarketplaceShareCard
              marketplaceUrl={`${getMarketplaceBaseUrlFromConfig()}/marketplace/${currentWorkspace.slug || currentWorkspace.id}`}
            ...
            {filteredListings.length === 0 ? (
              ...
              <div className="space-y-3">
                {filteredListings.map((listing) => {
                  ...
                  const listingUrl = `${getMarketplaceBaseUrlFromConfig()}/marketplace/${currentWorkspace?.slug || currentWorkspace?.id}/${listing.id}`;
