...
import { useClientTicketsAdmin, type ClientTicketRow, type TicketFilters } from "@/hooks/tickets/useClientTicketsAdmin";
...
import { Plus, Search, LayoutGrid, List, Headphones } from "lucide-react";
...
export default function TicketsList() {
  ...
  const { data: tickets = [], isLoading } = useClientTicketsAdmin(filters);
