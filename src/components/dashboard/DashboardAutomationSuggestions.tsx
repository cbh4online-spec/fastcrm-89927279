    ...
    <Card>
      ...
      <CardContent className="space-y-1">
        {suggestions.map((s) => (
          <div
            key={s.id}
            className="flex items-start justify-between gap-3 py-2.5 px-2 rounded-md hover:bg-muted/50 transition-colors"
          >
        ...
        <button
          className="w-full flex items-center justify-center gap-1.5 pt-2 text-xs text-muted-foreground hover:text-primary transition-colors"
