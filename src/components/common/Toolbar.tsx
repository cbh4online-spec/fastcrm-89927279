...
export function Toolbar({
  ...
  return (
    <div className={cn(
      ...
      "p-2 sm:p-3 rounded-lg bg-muted/30 border border-border/30",
      className
    )}>
      {/* Search - full width on mobile, positioned first */}
      {onSearchChange && (
        ...
        <div className="flex items-center gap-1.5 sm:gap-2 flex-wrap">
          ...
          {sortOptions && sortOptions.length > 0 && (
            <Select value={sortValue} onValueChange={onSortChange}>
              <SelectTrigger className="w-[110px] sm:w-[160px] h-8 text-xs sm:text-sm rounded-lg border-border/50 bg-background/50">
                <ArrowUpDown className="h-3 w-3 mr-1 sm:mr-2 text-muted-foreground shrink-0" />
