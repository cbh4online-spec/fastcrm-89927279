...
interface ContactAuditSectionProps {
  contactId: string;
}

export function ContactAuditSection({ contactId }: ContactAuditSectionProps) {
  const { data: entries, isLoading } = useContactAuditLog(contactId);
