      ...
      <div className="relative overflow-hidden rounded-xl border border-primary/20 bg-gradient-to-br from-primary/5 via-background to-primary/10 p-6">
        ...
        <div className="relative flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            ...
            <Button onClick={() => onOpenWizard?.()} className="bg-gradient-to-r from-primary to-primary/80 hover:from-primary/90 hover:to-primary/70 shadow-lg shadow-primary/20">
        ...
        <Card className="border-dashed border-2 border-primary/20">
          <CardContent className="flex flex-col items-center justify-center py-20 text-center">
            ...
            <div className="flex gap-3">
              <Button onClick={() => onOpenWizard?.()} className="bg-gradient-to-r from-primary to-primary/80 shadow-lg shadow-primary/20">
                <Plus className="h-4 w-4 mr-2" />
                Criar eBook
              </Button>
            </div>
