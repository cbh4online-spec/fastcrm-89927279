...
import { Save, CheckCircle2, RotateCcw, FileText, List } from "lucide-react";
      ...
      <DialogContent className="max-w-2xl max-h-[85vh] overflow-y-auto bg-card border-gold/20">
        ...
        <Tabs defaultValue="fields" className="mt-2">
          <TabsList className="w-full bg-muted/30">
            <TabsTrigger value="fields" className="flex-1 gap-1.5 text-xs">
              <List className="h-3.5 w-3.5" /> Campos
            </TabsTrigger>
