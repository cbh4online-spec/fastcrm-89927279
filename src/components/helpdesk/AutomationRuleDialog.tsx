...
export const AUTOMATION_TEMPLATES = [
  ...
  {
    name: "Notificar equipa — SLA violado",
    trigger_event: "on_sla_breach" as HelpdeskTrigger,
    conditions: {},
    action_type: "send_notification" as HelpdeskActionType,
    action_config: { message: "⚠️ SLA violado — ação imediata necessária" },
  },
  {
    name: "Fechar automaticamente após 7 dias sem resposta",
    trigger_event: "on_no_response" as HelpdeskTrigger,
    conditions: { days_inactive: "7" },
    action_type: "change_status" as HelpdeskActionType,
    action_config: { status: "closed" },
  },
  {
    name: "Notificar equipa — ticket reaberto",
    trigger_event: "on_reopen" as HelpdeskTrigger,
    conditions: {},
    action_type: "send_notification" as HelpdeskActionType,
    action_config: { message: "🔄 Ticket reaberto pelo cliente" },
  },
  {
    name: "Subir prioridade quando SLA violado",
    trigger_event: "on_sla_breach" as HelpdeskTrigger,
    conditions: {},
    action_type: "change_priority" as HelpdeskActionType,
    action_config: { priority: "urgent" },
  },
  {
    name: "Tag automática para tickets de faturação",
    trigger_event: "on_create" as HelpdeskTrigger,
    conditions: { type: "billing" },
    action_type: "add_tag" as HelpdeskActionType,
    action_config: { tag: "faturação" },
  },
];
