...
const temperatureConfig: Record<string, { label: string; emoji: string; color: string; bg: string }> = {
  cold: { label: "Frio", emoji: "❄️", color: "text-blue-500", bg: "bg-blue-500/10" },
  warm: { label: "Morno", emoji: "🟡", color: "text-amber-500", bg: "bg-amber-500/10" },
  hot: { label: "Quente", emoji: "🔥", color: "text-red-500", bg: "bg-red-500/10" },
};
