...
export const settingsSearchData: SearchableItem[] = [
  ...
  // Integrations & API
  {
    id: "integrations-billing-providers",
    category: "integrations",
    sectionTitle: "Programas de Faturação",
    sectionDescription: "InvoiceXpress, Moloni, Vendus, Sage, Primavera",
    itemTitle: "Ligar software de faturação",
    itemDescription: "Emitir e sincronizar faturas no CRM por API",
    keywords: [
      "invoicexpress", "moloni", "vendus", "sage", "primavera",
      "faturação", "faturas", "fatura", "billing", "sincronização", "api",
    ],
  },
  {
    ...
    category: "integrations",
    sectionTitle: "Stripe",
    sectionDescription: "Pagamentos, propostas, subscrições e renovações",
    itemTitle: "Webhook Settings",
    itemDescription: "Produtos & Preços",
    keywords: ["stripe", "pagamentos", "checkout", "subscrições"],
  },
  {
    id: "integrations-whatsapp",
    category: "integrations",
    sectionTitle: "WhatsApp Business",
    sectionDescription: "WhatsApp Business API",
    itemTitle: "Conectar WhatsApp",
    itemDescription: "Receber e enviar mensagens",
    keywords: ["whatsapp", "wa", "mensagens", "zapi", "evolution"],
  },
  {
    id: "integrations-video",
    category: "integrations",
    sectionTitle: "Videoconferência",
    sectionDescription: "Zoom e Google Meet",
    itemTitle: "Zoom & Google Meet",
    itemDescription: "Criar reuniões automaticamente",
    keywords: ["zoom", "google meet", "video", "reunião", "meeting"],
  },
  {
    id: "integrations-ghl",
    category: "integrations",
    sectionTitle: "GoHighLevel",
    sectionDescription: "Sincronizar contactos e mensagens",
    itemTitle: "Configurar GHL",
    itemDescription: "Sincronização CRM",
    keywords: ["gohighlevel", "ghl", "crm", "sincronização", "contactos"],
  },
  {
    id: "integrations-api",
    category: "integrations",
    sectionTitle: "API & Webhooks",
    sectionDescription: "Acesso programático ao CRM",
    itemTitle: "Chaves de API",
    itemDescription: "Documentação, Webhooks de saída",
    keywords: ["api", "webhooks", "rest", "developer"],
  },
  {
    id: "integrations-mcp",
    category: "integrations",
    sectionTitle: "Integrações MCP",
    sectionDescription: "Figma e outros providers MCP",
    itemTitle: "Providers MCP",
    itemDescription: "Importar design systems",
    keywords: ["mcp", "figma", "design system"],
  },
  {
    id: "integrations-variables",
    category: "integrations",
    sectionTitle: "Variáveis & Segredos",
    sectionDescription: "Tokens e variáveis usados em automações",
    itemTitle: "Variáveis de ambiente",
    itemDescription: "Segredos",
    keywords: ["variáveis", "segredos", "secrets", "tokens"],
  },
];
