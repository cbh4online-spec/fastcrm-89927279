...
import { Bell, Check, Trash2, Settings, MessageSquare, UserPlus, TrendingUp, AlertTriangle, GitBranch, Info, StickyNote, AtSign, Cake, Timer } from "lucide-react";
...
const typeIcons: Record<string, React.ReactNode> = {
  ...
  rfq_deadline: <Timer className="w-4 h-4 text-red-500" />,
};
