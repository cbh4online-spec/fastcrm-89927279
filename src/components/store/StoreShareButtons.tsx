...
interface StoreShareButtonsProps {
  url: string;
  title: string;
  description?: string;
  image?: string;
...
export function StoreShareButtons({ url, title, description, image }: StoreShareButtonsProps) {
  ...
  return (
    <div className="space-y-3">
      ...
      <div className="flex items-center gap-2 flex-wrap">
        ...
        {/* Native share (mobile) */}
        {hasNativeShare && (
          <Button variant="outline" size="icon" className="h-8 w-8 rounded-full" onClick={handleNativeShare} title="Partilhar">
        ...
        <Button variant="outline" size="icon" className="h-8 w-8 rounded-full" onClick={handleTwitter} title="X / Twitter">
          <XIcon className="h-4 w-4" />
        </Button>
        <Button variant="outline" size="icon" className="h-8 w-8 rounded-full" onClick={handleLinkedIn} title="LinkedIn">
          <LinkedInIcon className="h-4 w-4" />
        </Button>
        <Button variant="outline" size="icon" className="h-8 w-8 rounded-full" onClick={handleTelegram} title="Telegram">
