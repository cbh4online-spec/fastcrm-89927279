  ...
  public: {
    Tables: {
      ...
      c2c_categories: {
        ...
        Relationships: [
          {
            foreignKeyName: "c2c_categories_parent_id_fkey"
            columns: ["parent_id"]
            isOneToOne: false
      ...
      c2c_favorites: {
        ...
        Relationships: [
          {
            foreignKeyName: "c2c_favorites_listing_id_fkey"
            columns: ["listing_id"]
            isOneToOne: false
            referencedRelation: "c2c_listings"
            referencedColumns: ["id"]
      ...
      c2c_listings: {
        ...
        Relationships: [
          {
            foreignKeyName: "c2c_listings_category_id_fkey"
            columns: ["category_id"]
            isOneToOne: false
            referencedRelation: "c2c_categories"
            referencedColumns: ["id"]
      ...
      c2c_messages: {
        ...
        Relationships: [
          {
            foreignKeyName: "c2c_messages_listing_id_fkey"
            columns: ["listing_id"]
            isOneToOne: false
            referencedRelation: "c2c_listings"
            referencedColumns: ["id"]
      ...
      c2c_moderation_settings: {
        Row: {
          auto_flag_new_sellers: boolean | null
      ...
      c2c_reports: {
        ...
        Relationships: [
          {
            foreignKeyName: "c2c_reports_listing_id_fkey"
            columns: ["listing_id"]
            isOneToOne: false
            referencedRelation: "c2c_listings"
            referencedColumns: ["id"]
      ...
      c2c_reviews: {
        ...
        Relationships: [
          {
            foreignKeyName: "c2c_reviews_listing_id_fkey"
            columns: ["listing_id"]
            isOneToOne: false
            referencedRelation: "c2c_listings"
            referencedColumns: ["id"]
      ...
      community_members: {
        ...
        Relationships: [
          {
            foreignKeyName: "community_members_contact_id_fkey"
            columns: ["contact_id"]
            isOneToOne: false
            referencedRelation: "contacts"
            referencedColumns: ["id"]
      ...
      store_page_views: {
        ...
        Relationships: [
          {
            foreignKeyName: "store_page_views_product_id_fkey"
            columns: ["product_id"]
            isOneToOne: false
            referencedRelation: "product_usage_stats"
            referencedColumns: ["product_id"]
