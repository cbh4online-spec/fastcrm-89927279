  ...
  return useQuery({
    ...
    queryFn: async () => {
      ...
      return (data || []).map(t => ({
        ...
        structureType: t.structure_type || 'custom',
        cta: t.cta || undefined,
        isActive: t.is_active,
        usageCount: t.usage_count,
        conversionCount: t.conversion_count || 0,
        responseRate: t.response_rate,
        isDynamic: t.is_dynamic || false,
        dynamicRules: t.dynamic_rules || {},
        dynamicSchema: t.dynamic_schema || {},
        allowedChannels: t.allowed_channels || [],
        defaultTone: t.default_tone || 'consultative',
        status: t.status || 'active',
        personalizationLevel: t.personalization_level || 'basic',
        structureFamilies: t.structure_families || ['AIDA'],
        brandConstraints: t.brand_constraints || {},
        maxLengthByChannel: t.max_length_by_channel || { whatsapp: 350, email: 1600, sms: 160, inbox: 800 },
        tags: t.tags || [],
  ...
  return useQuery({
    ...
    queryFn: async () => {
      ...
      return {
        ...
        structureType: data.structure_type || 'custom',
        ...
        personalizationLevel: data.personalization_level || 'basic',
